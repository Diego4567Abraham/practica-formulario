...
function problema1() {
    //obtenerlos valores del input
    var p1_input = document.querySelector('#p1-input').Value;
    //identifique como dividirel texto por espacios
...
function problema3() {
    // definir alfabeto
    var alfabeto = ['Q', 'W', 'R', 'T', 'Y', 'U', 'I', 'O', 'P', 'A', 'S', 'D', 'F', 'G',
        'H', 'J', 'K', 'L', 'Ñ',
        'Z', 'X', 'C', 'V', 'B', 'N', 'M'
    ];
    ...
    p3_palabras.forEach(function(palabra, i) {
        ...
        alfabeto.forEach(function(letra, j) {
            ...
            palabra_array.forEach(function(letra_palabra, k) {
                ...
                if (letra_palabra == letra) {
                    //si la letra no lahemos encontrado, la agregamos ala array para contar las letras unicas 
                    if (lectura_unicas.indexOf(letras) < 0) {
                        lectura_unicas.push(letra);
                    }
                }
            });
        });
        ...
        p3_res += 'Palabra' + ' ' + palabra + '=' + '' + 'letras unicas' + ' ' +
            lectura_unicas.length + ' \n ';
    });
